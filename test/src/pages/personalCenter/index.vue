<template>
    <div id="personal-center-component">
        <header class="header">
            ...
            <div class="position" :class="level == '1' ? 'baijinbg' : 'zuanshibg'">
                ...
                <div class="isvip end-center">白金会员</div>
            ...
            <div class="bottom row">
                <div class="per-menu">
                    <div class="per-icon center"><van-icon name="http://sbs.91dianji.com.cn/303-check.png" size="30px" color="#dab17b"/></div>
                    <div class="per-title center" @click="handleExpect">积分</div>
                </div>
                 <div class="per-menu">
                    <div class="per-icon center"><van-icon name="http://sbs.91dianji.com.cn/304-check.png" size="30px" color="#dab17b"/></div>
                    <router-link tag="div" :to="{path: '/personalCenter/incomedetail/cash',query: {amount: amount}}" class="per-title center">可结算</router-link>
                </div>
                 <div class="per-menu">
                    <div class="per-icon center"><van-icon name="http://sbs.91dianji.com.cn/305-check.png" size="30px" color="#dab17b"/></div>
        ...
        <div class="pop" v-show="showCover">
                <van-popup v-model="show" :overlay="false" >
                   <div class="content">
                        <h1>温馨提示</h1>
                        <p>您现在即将升级成<span class="colum">随便刷钻石会员</span>升级成功后,您将享受相应收益权限。</p>
                        <p class="vip">
        ...
        <div class="per-list row">
            <router-link tag="div" class="per-menu-list line" :to="{path: '/ponserCenter/userAccountManage',query: {amount: amount,amountSum: amountSum}}">
                <div class="menu-icon center"><van-icon name="http://sbs.91dianji.com.cn/303.png" size="30px" color="#dab17b"/></div>
                <div class="per-menu-title center">账户管理</div>
            </router-link>
            <router-link tag="div" class="per-menu-list line" to="/personalCenter/previous">
                <div class="menu-icon center"><van-icon name="http://sbs.91dianji.com.cn/304.png" size="30px" color="#dab17b"/></div>
                <div class="per-menu-title center">上级推荐人</div>
            </router-link>
            <div class="per-menu-list" @click="handleExpect">
                <div class="menu-icon center"><van-icon name="http://sbs.91dianji.com.cn/305.png" size="30px" color="#dab17b"/></div>
                <div class="per-menu-title center">微名片</div>
            </div>
        </div>
        <div class="per-list row">
            <router-link tag="div" to="/personalCenter/cooperation" class="per-menu-list line">
                <div class="menu-icon center"><van-icon name="http://sbs.91dianji.com.cn/306.png" size="30px" color="#dab17b"/></div>
                <div class="per-menu-title center">商务合作</div>
            </router-link>

            <div class="per-menu-list line" @click="handleExpect">
                <div class="menu-icon center"><van-icon name="http://sbs.91dianji.com.cn/307.png" size="30px" color="#dab17b"/></div>
                <div class="per-menu-title center">共享佣金池</div>
            </div>

            <div class="per-menu-list" @click="handleExpect">
                <div class="menu-icon center"><van-icon name="http://sbs.91dianji.com.cn/308.png" size="30px" color="#dab17b"/></div>
        ...
        <div class="per-list row">
            <div class="per-menu-list line" @click="handleExpect">
                <div class="menu-icon center"><van-icon name="http://sbs.91dianji.com.cn/309.png" size="30px" color="#dab17b"/></div>
                <div class="per-menu-title center">VIP视频</div>
            </div>

            <div class="per-menu-list line"  @click="handleExpect">
                <div class="menu-icon center"><van-icon name="http://sbs.91dianji.com.cn/310.png" size="30px" color="#dab17b"/></div>
                <div class="per-menu-title center">流程说明</div>
            </div>

            <router-link tag="div" to="/personalCenter/manual" class="per-menu-list">
                <div class="menu-icon center"><van-icon name="http://sbs.91dianji.com.cn/311.png" size="30px" color="#dab17b"/></div>
        ...
        <div class="per-list row">
            <router-link tag="div" to="/personalCenter/questionandanswers" class="per-menu-list line">
                <div class="menu-icon center"><van-icon name="http://sbs.91dianji.com.cn/312.png" size="30px" color="#dab17b"/></div>
                <div class="per-menu-title center">百问百答</div>
            </router-link>

            <router-link tag="div" to="/personalCenter/contactus" class="per-menu-list line">
                <div class="menu-icon center"><van-icon name="http://sbs.91dianji.com.cn/313.png" size="30px" color="#dab17b"/></div>
                <div class="per-menu-title center">联系我们</div>
            </router-link>

            <div class="per-menu-list" @click="handleExpect">
                <div class="menu-icon center"><van-icon name="http://sbs.91dianji.com.cn/314.png" size="30px" color="#dab17b"/></div>
        ...
        <div  class="update">
            <ul>
                <li  @click="uploadAnd"  >
                    <van-icon name="http://sbs.91dianji.com.cn/Android.png"  size="90px" color="#dab17b"/>
                    <p> 安卓手机下载</p>
                </li>
                 <!-- <router-link @click="uploadIos"  tag="li"  :to="{path: '/loan/form/myOrder',query: {info: 'http://znd.hvv.dnf-w3.cn/KXxv61',title: '苹果下载'}}" >
           
                     <van-icon name="http://sbs.91dianji.com.cn/Android.png"  size="40px" color="#dab17b"/>
                    <p>苹果手机下载</p>
                 </router-link> -->
                 <li  @click="uploadIos">
                     <van-icon name="http://sbs.91dianji.com.cn/ios.png"  size="90px" color="#dab17b"/>
                    <p>苹果手机下载</p>
                 </li>
            </ul>
        </div>
            ...
            axiosPost(url,params).then(res =>{
                ...
                if(res.data.success){
                    ...
                    if(res.data.data.level == '0'){
                        ...
                        // this.showYYS=false
                        this.isUpgrade=true
                        this.vip ='http://sbs.91dianji.com.cn/huangjinVIP.png';
                    }else{
                        this.vip = 'http://sbs.91dianji.com.cn/zuanshivip.png';
                    }
                }else{
                    setTimeout(()=>{
                        this.componentload = false;
...
<style lang="less" scoped>
  #personal-center-component {
      ...
      .header{
          ...
          .baijinbg{
              background: url('http://sbs.91dianji.com.cn/baijinbg.png') center center no-repeat;
          }
          .zuanshibg{
              background: url('http://sbs.91dianji.com.cn/zuanshibg.png') center center no-repeat;
          }
          .position{
              width: 90%;
              height: 350px;
            ...
            //   border: solid 1px #ffffff;
              ...
              .position-detail{
                  ...
                  .shou{
                      background: url('http://sbs.91dianji.com.cn/3-shou.png') no-repeat;
                      background-size: 70% 70%;
                      background-position: 50% 142%;
                  }
                  .yu{
                      background: url('http://sbs.91dianji.com.cn/3-yu.png') no-repeat;
                      background-size: 80% 60%;
                      background-position: 50% 100%;
                  }
                  .fen{
                      background: url('http://sbs.91dianji.com.cn/3-fen.png') no-repeat;
                      background-size: 80% 60%;
                      background-position: 50% 100%;
                  }
                  .right{

<template>
    <div id="manual">
        ...
        <div class="small-title">
            ...
            <div class="per-bold-content"><span class="bold-title">随便刷视频：</span>在分享页面点击（随便刷视频）进入详情页面，用户可在此分享随便刷视频</br></div>
            ...
            <div class="per-bold-content"><span class="bold-title">分享链接：</span>在分享页面点击（分享链接）进入详情页面，在此生成分享随便刷链接</br></div>

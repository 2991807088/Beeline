<template>
    <div id="payment">
        ...
        <div class="container">
           ...
           <div class="record">
                <van-button   :to="{path: '/home/collect/payment/records',query: {chMerCode:chMerCode}}" round size="middle"  type="info">交易查询</van-button>
                <van-button  @click="change" round size="middle"  type="info">更改收款账户</van-button>
           </div>
        </div>

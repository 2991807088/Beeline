...
<template>
    <div id="receive">
        ...
        <header class="header-top row">
            ...
            <div class="top-title center">在线收款</div>
        ...
        <div class="container">
            ...
            <div class="merchant">
                    ...
                    <div class="card" v-show="showCard">
                        <ul>
                            <li>
                                ...
                                <!-- <router-link tag="p" to="/home/receiveXH/cardCX" class="change">更换<van-icon  name="arrow"  color="#EBB541" /></router-link> -->
                                <p  @click="getcxcard" class="change">更换<van-icon  name="arrow"  color="#EBB541" /></p>
                            </li>
                             ...
                             <li>
                                ...
                                <!-- <router-link tag="p" :to="{query:{type:'2',merchantno:merchantno},path:'/home/receivables/cards'}"  class="change">选择<van-icon  name="arrow"   color="#EBB541" /></router-link> -->
                ...
                <!-- <p><van-icon size="46px" name="http://wy.91dianji.com.cn/paytype.png" /></p> -->
             ...
             <div class="statistics">
              ...
              <div class="covercx" >
                    <van-popup v-model="showxy" position="right" >
                         <div class="action">
                             <!-- <van-icon name="add" @click="addcard"  size="30px" color="#EBB541" />
                             <van-icon name="clear" @click="closexy" size="30px" color="#EBB541" /> -->
                            <van-button  to="/home/creditHousekeeper/aisleHousekeeper/bindingCreditCard" size="large" round type="primary">添加信用卡</van-button>
                             <van-button @click="closexy" size="large" round type="default">关闭</van-button>
                        </div>
                         <div class="cards">
                             <ul>
              ...
              <div class="covercx" >
                    <van-popup v-model="showcx" position="right" >
                        <div class="action">
                             <!-- <van-icon name="add" @click="addcardcx"  size="30px" color="#EBB541" />
                             <van-icon name="clear" @click="closecx" size="30px" color="#EBB541" /> -->
                           
                            <van-button  to="/personalCenter/addcard/UnionPay" round size="large"  type="primary">添加储蓄卡</van-button>
                             <van-button @click="closecx" size="large" round type="default">关闭</van-button>
                        </div>

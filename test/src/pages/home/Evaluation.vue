<template>
    <div id="page-component-form">
        ...
        <div class="clause">
            <div class="center"><van-checkbox v-model="checked" @change="handleAgree" shape="square" checked-color="#f3b500">阅读并同意<span @click="handleShow">《金蜜蜂服务协议》</span></van-checkbox></div>
        </div>
